const FORTUNE_500_GLOBAL = [
  // 1. Retail & Consumer (Global)
  { lei: '549300AMAZON00012345', name: 'AMAZON.COM, INC.', sector: 'Retail & Consumer', country: 'United States', city: 'Seattle', lat: 47.6062, lon: -122.3321, domain: 'amazon.com', emp: 1525000, rev: 574800, nis2: 'DORA · Critical ICT Provider (AWS)', cik: '0001018724' },
  ...
  // 2. Energy, Utilities & State Infrastructure (Global)
  { lei: '549300STATEGRID00123', name: 'STATE GRID CORPORATION OF CHINA', sector: 'Energy & Utilities', country: 'China', city: 'Beijing', lat: 39.9042, lon: 116.4074, domain: 'sgcc.com.cn', emp: 1860000, rev: 530000, nis2: 'Critical Grid Infrastructure Entity' },
  ...
  { lei: '335800RELIANCE001234', name: 'RELIANCE INDUSTRIES LIMITED', sector: 'Energy & Utilities', country: 'India', city: 'Mumbai', lat: 19.0760, lon: 72.8777, domain: 'ril.com', emp: 389000, rev: 118800, nis2: 'Critical Infrastructure Entity' },

  // 3. Oil, Gas & Chemicals (Global)
  { lei: '549300V5T0XJ9R5V0B12', name: 'SAUDI ARABIAN OIL COMPANY (SAUDI ARAMCO)', sector: 'Oil, Gas & Chemicals', country: 'Saudi Arabia', city: 'Dhahran', lat: 26.2361, lon: 50.0393, domain: 'aramco.com', emp: 73000, rev: 494900, nis2: 'Systemic Energy Infra' },
  { lei: '549300CNPC0000000123', name: 'CHINA NATIONAL PETROLEUM CORPORATION (CNPC)', sector: 'Oil, Gas & Chemicals', country: 'China', city: 'Beijing', lat: 39.9042, lon: 116.4074, domain: 'cnpc.com.cn', emp: 1080000, rev: 429700, nis2: 'Systemic Energy Infra' },
  { lei: '549300SINOPEC0000001', name: 'SINOPEC GROUP', sector: 'Oil, Gas & Chemicals', country: 'China', city: 'Beijing', lat: 39.9042, lon: 116.4074, domain: 'sinopec.com', emp: 527000, rev: 429000, nis2: 'Systemic Energy Infra' },
  ...
  { lei: '549300PETROBRAS00123', name: 'PETROLEO BRASILEIRO S.A. (PETROBRAS)', sector: 'Oil, Gas & Chemicals', country: 'Brazil', city: 'Rio de Janeiro', lat: -22.9068, lon: -43.1729, domain: 'petrobras.com.br', emp: 46000, rev: 102400, nis2: 'Critical Energy Infra' },

  // 4. Technology, SaaS & Hardware (Global)
  ...
  { lei: '549300FOXCONN0000001', name: 'HON HAI PRECISION INDUSTRY (FOXCONN)', sector: 'Technology & SaaS', country: 'Taiwan', city: 'New Taipei City', lat: 24.9980, lon: 121.4500, domain: 'foxconn.com', emp: 1000000, rev: 223000, nis2: 'Critical Electronics Supply Chain' },
  { lei: '549300SAMSUNG0000012', name: 'SAMSUNG ELECTRONICS CO., LTD.', sector: 'Technology & SaaS', country: 'South Korea', city: 'Suwon', lat: 37.2636, lon: 127.0286, domain: 'samsung.com', emp: 270000, rev: 198300, nis2: 'Critical Tech Hardware Provider' },
  ...
  { lei: '549300ALIBABA0000123', name: 'ALIBABA GROUP HOLDING LIMITED', sector: 'Technology & SaaS', country: 'China', city: 'Hangzhou', lat: 30.2741, lon: 120.1551, domain: 'alibaba.com', emp: 219000, rev: 130000, nis2: 'Critical Cloud Provider (AliCloud)' },
  { lei: '549300TENCENT0000123', name: 'TENCENT HOLDINGS LIMITED', sector: 'Technology & SaaS', country: 'China', city: 'Shenzhen', lat: 22.5431, lon: 114.0579, domain: 'tencent.com', emp: 105000, rev: 86000, nis2: 'Critical Internet Infra' },
  { lei: '549300SONYGROUP00123', name: 'SONY GROUP CORPORATION', sector: 'Technology & SaaS', country: 'Japan', city: 'Tokyo', lat: 35.6762, lon: 139.6503, domain: 'sony.com', emp: 113000, rev: 86000, nis2: 'Critical Consumer Tech Entity' },
  ...
  { lei: '549300TSMC0000000123', name: 'TAIWAN SEMICONDUCTOR MFG CO (TSMC)', sector: 'Technology & SaaS', country: 'Taiwan', city: 'Hsinchu', lat: 24.7818, lon: 120.9942, domain: 'tsmc.com', emp: 76000, rev: 69300, nis2: 'Systemic Semiconductor Foundries' },
  { lei: '549300HITACHI0000123', name: 'HITACHI, LTD.', sector: 'Technology & SaaS', country: 'Japan', city: 'Tokyo', lat: 35.6762, lon: 139.6503, domain: 'hitachi.com', emp: 322000, rev: 67000, nis2: 'DORA / NIS2 · Industrial Automation' },
  ...
  // 5. Healthcare & Life Sciences (Global)
  ...
  // 6. Banking & Capital Markets (Global)
  { lei: '549300ICBC0000000123', name: 'INDUSTRIAL & COMMERCIAL BANK OF CHINA (ICBC)', sector: 'Banking & Capital Mkts', country: 'China', city: 'Beijing', lat: 39.9042, lon: 116.4074, domain: 'icbc.com.cn', emp: 427000, rev: 222000, nis2: 'DORA · Systemic Global Financial Institution' },
  ...
  // 7. Automotive & Mobility (Global)
  { lei: '529900VWGROUP0000123', name: 'VOLKSWAGEN AG', sector: 'Automotive & Mobility', country: 'Germany', city: 'Wolfsburg', lat: 52.4227, lon: 10.7865, domain: 'volkswagen-group.com', emp: 676000, rev: 348000, nis2: 'DORA / NIS2 · Automotive Infra' },
  { lei: '549300GJQLMR6CNLME96', name: 'TOYOTA MOTOR CORPORATION', sector: 'Automotive & Mobility', country: 'Japan', city: 'Toyota City', lat: 35.0824, lon: 137.1562, domain: 'toyota-global.com', emp: 375000, rev: 312000, nis2: 'Systemic Automotive Infra' },
  { lei: '549300STELLANTIS0123', name: 'STELLANTIS N.V.', sector: 'Automotive & Mobility', country: 'Netherlands', city: 'Hoofddorp', lat: 52.3039, lon: 4.6931, domain: 'stellantis.com', emp: 272000, rev: 205000, nis2: 'DORA / NIS2 · Automotive Infra' },
  ...
  { lei: '549300HYUNDAI0000123', name: 'HYUNDAI MOTOR COMPANY', sector: 'Automotive & Mobility', country: 'South Korea', city: 'Seoul', lat: 37.5665, lon: 126.9780, domain: 'hyundai.com', emp: 120000, rev: 123000, nis2: 'Critical Automotive Infra' },
  ...
  { lei: '335800TATAMOTORS0123', name: 'TATA MOTORS LIMITED', sector: 'Automotive & Mobility', country: 'India', city: 'Mumbai', lat: 19.0760, lon: 72.8777, domain: 'tatamotors.com', emp: 81000, rev: 52000, nis2: 'Critical Mobility Infra' },

  // 8. Aerospace & Defence (Global)
  ...
  // 9. Industrial & Infrastructure (Global)
  ...
  { lei: '549300BHPGROUP000123', name: 'BHP GROUP LIMITED', sector: 'Industrial & Infra', country: 'Australia', city: 'Melbourne', lat: -37.8136, lon: 144.9631, domain: 'bhp.com', emp: 80000, rev: 53800, nis2: 'Critical Mining & Infrastructure' },

  // 10. Telecommunications (Global)
